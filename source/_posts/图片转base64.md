...
<body>
    ...
    <p id="container1"></p>
    <script>
    getBase64("http://img.mp.itc.cn/upload/20170816/d4b0f9df5f1646a7a624b80a101df9dc_th.jpg")
...
<script>
function change(obj) {
    var file = document.getElementById("FileUploadx1").files[0];
    var reader = new FileReader();
    reader.readAsDataURL(file[0])
    reader.onload = function(e) {
        $('#addImg1').attr('src', this.result)
    }

    var imgs = "";
    var formFile = new FormData();
    var fileObj = document.getElementById("FileUploadx1").files[0]; // js 获取文件对象
    formFile.append("imageurl", fileObj); //加入视频图片
    ...
    $.ajax({
        url: "data.aspx?book=savescimage",
        data: data,
        type: "Post",
        dataType: "json",
